...
A modern, responsive event landing page built using **HTML, CSS, and TypeScript**.  
The website includes multiple sections with smooth navigation and a functional booking form with validation.
...
- Booking form with validation and success feedback
...
- **HTML5** – Structure
- **CSS3** – Styling & layout
- **TypeScript** – Form validation and interactions
- **JavaScript (compiled)** – Browser execution
...
Built as a hands-on frontend learning project to understand real-world UI development, navigation, and form handling.
